                ...
                <div class="bg-light rounded-xl p-6 max-w-4xl mx-auto">
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <div id="price_input" style="display:<?php echo $software['is_paid'] == 1 ? 'block' : 'none'; ?>;" class="bg-gray-800 p-4 rounded-lg w-full">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="payment_link" value="<?php echo htmlspecialchars($software['payment_link']); ?>" placeholder="e.g. https://razorpay.me/..." class="w-full px-4 py-2 rounded-lg border">
                                    </div>
                                </div>
                            </div>
                        </div>
