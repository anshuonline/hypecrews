...
<head>
    ...
    <meta name="description" content="Page not found — The page you're looking for doesn't exist or has been moved. Return to Hypecrews homepage to explore our digital services.">
        ...
        <div class="container mx-auto px-4 text-center">
            <div class="max-w-3xl mx-auto">
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-4">
                    <a href="/" class="bg-gradient-to-r from-primary to-secondary hover:from-indigo-600 hover:to-purple-700 text-white font-bold py-3 px-8 rounded-lg transition">Go Home</a>
                ...
                <div class="mt-16">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-2xl mx-auto">
                        <a href="/#services" class="bg-dark p-6 rounded-xl shadow-lg hover:shadow-xl transition border border-gray-800">
