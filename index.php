                ...
                <div class="relative">
                    ...
                    <div class="relative z-10 transform rotate-3 transition-all duration-500 hover:rotate-6">
                        <div class="bg-gradient-to-br from-primary/20 to-secondary/20 backdrop-blur-sm rounded-3xl p-6 shadow-2xl border border-white/10">
                            <img src="https://images.unsplash.com/photo-1552664730-d307ca884978?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80" alt="Digital Marketing" class="rounded-2xl w-full shadow-lg">
                        </div>
                    </div>
            ...
            <div class="animate-slide">
                ...
                <div class="flex-shrink-0 flex items-center justify-center p-8 bg-light rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 w-64 inline-flex mx-4">
                    <div class="flex items-center">
                        ...
                        <span class="text-2xl font-bold text-white">Google</span>
                    </div>
                </div>
                ...
                <div class="flex-shrink-0 flex items-center justify-center p-8 bg-light rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 w-64 inline-flex mx-4">
                    <div class="flex items-center">
                        <div class="w-12 h-12 rounded-full bg-white flex items-center justify-center mr-4">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-8 h-8">
                                <path fill="#FF9900" d="M10.13 17.76c-.1-.15-.13-.33-.13-.53v-1.11h3.63v.53c0 .2-.03.38-.13.53-.1.15-.28.25-.48.25h-2.4c-.2 0-.38-.1-.48-.25zm-3.63-5.49c0-.2.03-.38.13-.53.1-.15.28-.25.48-.25h2.4c.2 0 .38.1.48.25.1.15.13.33.13.53v1.11h-3.63v-.53zm12.13 5.49c-.1-.15-.13-.33-.13-.53v-1.11h3.63v.53c0 .2-.03.38-.13.53-.1.15-.28.25-.48.25h-2.4c-.2 0-.38-.1-.48-.25zm-3.63-5.49c0-.2.03-.38.13-.53.1-.15.28-.25.48-.25h2.4c.2 0 .38.1.48.25.1.15.13.33.13.53v1.11h-3.63v-.53z"/>
                                <path fill="#146EB4" d="M20 8.69V4h-4.69L12 .69 8.69 4H4v4.69L.69 12 4 15.31V20h4.69L12 23.31 15.31 20H20v-4.69L23.31 12 20 8.69zM12 18c-3.31 0-6-2.69-6-6s2.69-6 6-6 6 2.69 6 6-2.69 6-6 6zm0-10c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4z"/>
                            </svg>
                        </div>
                ...
                <div class="flex-shrink-0 flex items-center justify-center p-8 bg-light rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 w-64 inline-flex mx-4">
                    <div class="flex items-center">
                        ...
                        <span class="text-2xl font-bold text-white">Facebook</span>
                    </div>
                </div>
                ...
                <div class="flex-shrink-0 flex items-center justify-center p-8 bg-light rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 w-64 inline-flex mx-4">
                    <div class="flex items-center">
                        ...
                        <span class="text-2xl font-bold text-white">YouTube</span>
                    </div>
                </div>
